...
# 
#6. Najczęściej używane funkcje pakietu dplyr: ----
...
#7. mutate() – tworzenie nowych zmiennych na bazie istniejących ----
...
#8. filter() – wybieranie wierszy ----
#9. select() – wybieranie kolumn ----
...
#11. group_by() – grupowanie ----
#12. summarise() - obliczanie wartości zagregowanych (np. średnich, sum) ----
...
# 13.1 Prosty wykres punktowy: urbanizacja a PKB per capita ----
...
# 13.2 Zaawansowany wykres punktowy: urbanizacja a PKB per capita ----
...
# 13.3 Zaawansowany wykres punktowy: rozmiar gospodarki a populacja ----
...
# 13.4 Prosty wykres słupkowy: liczba krajów w regionach ----
...
# 13.5 Zaawansowany wykres słupkowy poziomy: TOP 15 najbogatszych krajów ----
kraje %>%
   arrange(desc(PKB_per_capita)) %>%
   head(15) %>%
...
# 13.6 Wykres pudełkowy (boxplot): dostęp do internetu według regionów ----
...
# 13.7 Wykres pudełkowy (boxplot): przyrost populacji według regionów ----
